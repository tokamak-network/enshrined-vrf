...
<Note>
  This reference page will be auto-generated from Solidity NatSpec in a later pass. For now it mirrors [`IEnshrainedVRF.sol`](https://github.com/tokamak-network/enshrined-vrf/blob/enshrined-vrf/packages/contracts-bedrock/interfaces/L2/IEnshrainedVRF.sol) by hand.
</Note>
