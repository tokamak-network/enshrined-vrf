...
var (
	...
	EnshrainedVRF = &Hardfork{Name: string(forks.EnshrainedVRF), Precedence: 10}
)

var (
	Hardforks      = ForkMatrix{Regolith, Canyon, Delta, Ecotone, Fjord, Granite, Holocene, Isthmus, Jovian, EnshrainedVRF}
