...
const DICT: Record<Lang, Record<string, string>> = {
  ko: {
    ...
    'landing.featuresEyebrow': '세 가지 원칙',
    ...
    'janken.nav.section': '메뉴',
    'janken.nav.game': '게임',
    'janken.nav.lp': 'LP 풀',
    'janken.nav.leaderboard': '리더보드',
    'janken.nav.gameSub': '플레이 · VRF 라운드',
    'janken.nav.lpSub': '예치 · 인출 · 풀 지분',
    'janken.nav.leaderboardSub': '랭킹 · 누적 통계',
    'janken.leaderboard.title': '리더보드',
    'janken.leaderboard.tag': '곧 공개',
    'janken.leaderboard.soon': '온체인 라운드 인덱싱이 준비되는 대로 누적 PnL · 승률 · 최대 멀티플라이어 랭킹이 여기에 표시됩니다.',
    'janken.leaderboard.col.rank': '순위',
    'janken.leaderboard.col.player': '플레이어',
    'janken.leaderboard.col.pnl': '누적 PnL',
    'janken.leaderboard.col.rounds': '라운드',
    'janken.leaderboard.col.best': '최고 배율',
    'janken.board': '플레이 보드',
    'janken.slip': '베팅 슬립',
  ...
  en: {
    ...
    'landing.featuresEyebrow': 'Three pillars',
    ...
    'janken.tab.play': 'Play',
    'janken.tab.liquidity': 'Liquidity',
    'janken.nav.section': 'Menu',
    'janken.nav.game': 'Game',
    'janken.nav.lp': 'LP Pool',
    'janken.nav.leaderboard': 'Leaderboard',
    'janken.nav.gameSub': 'Play · VRF rounds',
    'janken.nav.lpSub': 'Deposit · withdraw · pool share',
    'janken.nav.leaderboardSub': 'Rankings · lifetime stats',
    'janken.leaderboard.title': 'Leaderboard',
    'janken.leaderboard.tag': 'coming soon',
    'janken.leaderboard.soon': 'Lifetime PnL, win-rate, and max-multiplier rankings will appear here as soon as on-chain round indexing comes online.',
    'janken.leaderboard.col.rank': 'rank',
    'janken.leaderboard.col.player': 'player',
    'janken.leaderboard.col.pnl': 'lifetime PnL',
    'janken.leaderboard.col.rounds': 'rounds',
    'janken.leaderboard.col.best': 'best ×',
