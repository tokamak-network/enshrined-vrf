...
const DICT = {
  ko: {
    ...
    'landing.eyebrow':     '✦ on-chain mini-arcade, on L2',
    'landing.h1':          '공정한 <span class="chip">미니게임</span>,<br>손그림 <span class="chip b">난수</span>,<br>온체인 <span class="chip c">아케이드</span>',
    'landing.lede':        'L2 컨트랙트가 <code>VRF.getRandomness()</code>를 한 번 호출하면 끝. 오라클도, 콜백도, 수상한 서버도 없이 — 단일 트랜잭션 안에서 귀엽게 해결.',
    ...
    'landing.preview.n':   '5개의 미니게임이 열려 있어요',
  ...
  en: {
    ...
    'landing.title':       'Tokamak Arcade · play fair, play cute',
    'landing.eyebrow':     '✦ on-chain mini-arcade, on L2',
    'landing.h1':          'fair <span class="chip">play</span>,<br>hand-drawn <span class="chip b">randomness</span>,<br>on-chain <span class="chip c">arcade</span>',
    ...
    'landing.preview.n':   '5 mini-games currently open',
